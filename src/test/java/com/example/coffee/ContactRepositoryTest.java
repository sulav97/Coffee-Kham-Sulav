...
public class ContactRepositoryTest {
    ...
    public void saveContactTest() {
        ...
        Assertions.assertThat(contact.getId()).isGreaterThan(74);
    }
    ...
    public void getListOfContactTest(){
        ...
        Assertions.assertThat(User.size()).isGreaterThan(23);
    }
...
//        @Query(value = "SELECT * from")
        ...
        Optional<Contact> optionalContact = contactRepo.
                findContactByEmail("a@g.com");
